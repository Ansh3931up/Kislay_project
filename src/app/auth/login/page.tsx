  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message === 'Please verify your email before logging in') {
        ...
        setSuccessMessage('Need to verify? Click the button below to enter verification code');
      } else {
          ...
          <div className="bg-green-900/50 border border-green-500 text-green-200 rounded-md p-4 mb-6">
            ...
            {error === 'Please verify your email before logging in' && (
              <button
                ...
                className="mt-2 w-full text-center py-2 px-3 text-sm font-medium text-white bg-green-800/50 hover:bg-green-800 rounded-md transition-colors"
              >
